...
abstract class TweetSet {
   ...
   * and be implemented in the subclasses?
   */
  // pass a predicate which is always true, i.e, do not filter any element out and merges with "this"
...
class Empty extends TweetSet {
  ...
  // implemented methods are : filterAcc, isEmpty, mostRetweeted
...
object GoogleVsApple {
  ...
  def companyTweets(keywords: List[String]) =
    TweetReader.allTweets filter (tweet => keywords.exists(tweet.text.contains)) //this is more idiomatic than contains(_)
